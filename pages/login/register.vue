	...
	<view class="login-page page-common">
		...
		<view class="login-page-container">
			<view class="login-page-wrap">
				...
				<view class="content">
					<view class="top" v-if="registerType == 0">
						<view class="title">
							<text>手机号注册</text>
						</view>
					</view>
					<view class="top" v-if="registerType == 1">
						<view class="title">
							<text>手机号注册</text>
						</view>
					</view>
					<view class="login-plate">
						...
						<view class="change-type login-plate-item">
							<view class="change-type-wrap" v-if="registerType == 0">
								<view class="btn-wrap" v-if="registerType == 0" @click="changeregisterType(1)">
									<text class="">账号密码注册</text>
								</view>
							</view>
							<view class="change-type-wrap" v-if="registerType == 1">
								<view class="btn-wrap" @click="changeregisterType(0)">
									<text class="">短信验证码注册</text>
								</view>
							</view>
						</view>
						<view class="login-btn login-plate-item">
							<view class="btn-wrap" @click="register">
...
<script>
import { registerPSW } from '@/api/user/user.js'
